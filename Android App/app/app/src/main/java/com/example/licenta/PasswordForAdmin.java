...
public class PasswordForAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_password_for_admin);
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PasswordForAdmin.this, MainActivity.class));
            }
        });
        ...
        procedeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (password.length() == 0){
                    ...
                    String response = postCheckPasswordAdmin(hash);
...
//                }).start();
                    try {
                        ...
                        if(textRecived.equals("wrong password")){
                            ...
                            startActivity(new Intent(PasswordForAdmin.this, Admin.class));
                        }
    ...
    public String postCheckPasswordAdmin(String md5){
        Log.d("OKHTTP3","Post function for password lock");
        String url = Route.link+"/adminPassword";
